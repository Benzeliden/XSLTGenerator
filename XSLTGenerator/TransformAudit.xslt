          ...
          <Body>
            ...
            <ReportItems>
              <Tablix Name="TablixConditions">
                  ...
                  <TablixRows>
                    <TablixRow>
                      ...
                      <TablixCells>
                        <xsl:for-each select="Fields/FieldDef">
                          <xsl:choose>
                            <xsl:when test="FirstColumn = 'true' ">
                              <TablixCell>
                                <CellContents>
                                  <Textbox Name="Textbox1">
                                    ...
                                    <Height>0.25in</Height>
                                    <Width>
                                      <xsl:value-of select="/TransformObject/TotalWidth"/>in
                                    </Width>
                                    <ZIndex>1</ZIndex>
                                    <Style>
                                      <Border>
                                  ...
                                  <ColSpan>
                                    <xsl:value-of select="count(/TransformObject/Fields/FieldDef)" />
                                  </ColSpan>
                                </CellContents>
                              </TablixCell>
                            </xsl:when>
                ...
                <DataSetName>Conditions</DataSetName>
                <Height>0.25in</Height>
                <Width>
                  <xsl:value-of select="TotalWidth"/>in
                </Width>
                <Visibility>
                  <Hidden>=Globals!RenderFormat.Name = "Excel"</Hidden>
                </Visibility>
                <Style>
                  <Border>
                    <Style>None</Style>
              ...
              <Textbox Name="TextboxConditionsExcel">
                <CanGrow>true</CanGrow>
                <KeepTogether>true</KeepTogether>
                <Paragraphs>
                  <Paragraph>
                ...
                <rd:DefaultName>TextboxConditionsExcel</rd:DefaultName>
              ...
              <Tablix Name="Tablix4">
                <TablixBody>
                  ...
                  <TablixRows>
                    <xsl:if test="NeedAuditHeader = 'true'">
                      <TablixRow>
                        <Height>0.25in</Height>
                        <TablixCells>
                          <xsl:for-each select="Fields/FieldDef">
                            <xsl:choose>
                              <xsl:when test="StartAuditHeader = 'true' ">
                                <TablixCell>
                                  <CellContents>
                                    <Textbox Name="TextboxAuditData">
                                      <CanGrow>true</CanGrow>
                                      <KeepTogether>true</KeepTogether>
                                      <Paragraphs>
                                        <Paragraph>
                                          <TextRuns>
                                            <TextRun>
                                              <Value>Audit Data</Value>
                                              <Style>
                                                <FontSize>10.25pt</FontSize>
                                      ...
                                      <rd:DefaultName>TextboxAuditData</rd:DefaultName>
                                      <Style>
                                        <Border>
                                          <Color>#8f9eaf</Color>
                                          <Style>Solid</Style>
                                    ...
                                    <ColSpan>
                                      <xsl:value-of select="/TransformObject/AuditCount" />
                                    </ColSpan>
                                  </CellContents>
                                </TablixCell>
                              </xsl:when>
                              <xsl:when test="StartNormalHeader = 'true'">
                                <TablixCell>
                                  <CellContents>
                                    <Textbox Name="TextboxActualData">
                                      <CanGrow>true</CanGrow>
                                      <KeepTogether>true</KeepTogether>
                                      <Paragraphs>
                                        <Paragraph>
                                      ...
                                      <rd:DefaultName>TextboxActualData</rd:DefaultName>
                                      <Style>
                                        <Border>
                                          <Color>#8f9eaf</Color>
                                          <Style>Solid</Style>
                                    ...
                                    <ColSpan>
                                      <xsl:value-of select="/TransformObject/NonAuditCount" />
                                    </ColSpan>
                                  </CellContents>
                                </TablixCell>
                              </xsl:when>
                ...
                <xsl:if test="count(Sorting/SortingProperty) > 0">
                  <SortExpressions>
                    <xsl:for-each select="Sorting/SortingProperty" >
                      <SortExpression>
                        <Value>
                          =Fields!<xsl:value-of select="Name"/>.Value
                        </Value>
